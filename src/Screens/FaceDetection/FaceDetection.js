...
export default class FaceDetection extends React.Component {
  ...
  renderTopBar = () => (
    <View style={styles.topBar}>
      ...
      <Pressable style={styles.toggleButton} onPress={this.toggleFacing}>
        <Ionicons name="ios-camera-reverse" size={32} color="white" />
      </Pressable>
      <Pressable style={styles.toggleButton} onPress={this.toggleFlash}>
        <MaterialIcons
      ...
      <Pressable style={styles.toggleButton} onPress={this.toggleWB}>
        <MaterialIcons
      ...
      <Pressable style={styles.toggleButton} onPress={this.toggleFocus}>
        <Text
          style={[
  ...
  renderBottomBar = () => (
    <View style={styles.bottomBar}>
      <Pressable style={styles.bottomButton} onPress={this.toggleMoreOptions}>
        <Octicons name="kebab-horizontal" size={30} color="white" />
      </Pressable>
      <View style={{ flex: 0.4 }}>
        <Pressable onPress={this.takePicture} style={{ alignSelf: "center" }}>
          <Ionicons name="ios-radio-button-on" size={70} color="white" />
        </Pressable>
      </View>
      <Pressable style={styles.bottomButton} onPress={this.toggleView}>
        <View>
  ...
  renderMoreOptions = () => (
    <View style={styles.options}>
      <View style={styles.detectors}>
        <Pressable onPress={this.toggleFaceDetection}>
          <MaterialIcons
            name="tag-faces"
            size={32}
        ...
        <Pressable onPress={this.toggleBarcodeScanning}>
          <MaterialCommunityIcons
            name="barcode-scan"
            size={32}
      ...
      <View style={styles.pictureSizeContainer}>
        ...
        <View style={styles.pictureSizeChooser}>
          <Pressable onPress={this.previousPictureSize} style={{ padding: 6 }}>
            <Ionicons name="md-arrow-back-circle" size={14} color="white" />
          </Pressable>
          <View style={styles.pictureSizeLabel}>
            <Text style={{ color: "white" }}>{this.state.pictureSize}</Text>
          </View>
          <Pressable onPress={this.nextPictureSize} style={{ padding: 6 }}>
            <Ionicons name="md-arrow-forward-circle" size={14} color="white" />
          </Pressable>
        </View>
      </View>
    </View>
