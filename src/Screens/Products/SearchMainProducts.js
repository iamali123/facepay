...
class SearchMainProducts extends React.Component {
  constructor(props) {
    super(props);
      ...
      <>
        ...
        <ScrollView overScrollMode="never">
          <View style={styles.filteredProducts}>
            ...
            >
              <Text style={baseStyle.h4}>Shakes</Text>
              <Image
            ...
            >
              <Text style={baseStyle.h4}>Salad & Fries</Text>
              <Image
                style={styles.rightArrow}
                source={require("../../../assets/images/icon-arrow-left.png")}
              ></Image>
            ...
            >
              <Text style={baseStyle.h4}>Pizza & Burger</Text>
              <Image
                style={styles.rightArrow}
                source={require("../../../assets/images/icon-arrow-left.png")}
              ></Image>
...
export default SearchMainProducts;
