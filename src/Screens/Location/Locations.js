...
class Locations extends React.Component {
  constructor(props) {
    ...
    this.state = {
      filterList: [
        { Title: " Location1", activeFilter: true, Id: 0 },
        { Title: "Location1", activeFilter: false, Id: 1 },
        { Title: "Location1", activeFilter: false, Id: 2 },
      ],
      searchInput: "",
    };
  }
    ...
    return (
      <>
        ...
        <Header
          ...
          onPressRightButton={() =>
            this.props.navigation.navigate("AddLocations")
          }
        />
        <ScrollView overScrollMode="never">
          ...
          <View style={baseStyle.themeContainer}>
            <View style={[baseStyle.row, styles.parentCategory]}>
              <View style={styles.leftCol}>
                <Text style={baseStyle.h4}>
                  621 Amsterdam Ave, New York, NY 10024 United Statess
                </Text>
              </View>
            ...
            <View style={[baseStyle.row, styles.parentCategory]}>
              <View style={styles.leftCol}>
                <Text style={baseStyle.h4}>621 Amsterdam New York, Ave</Text>
              </View>
              <View style={styles.rightCol}>
                <Pressable
                  style={[baseStyle.editDelButton]}
